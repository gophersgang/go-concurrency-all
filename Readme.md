...
- [abhi-bit/go2c](https://github.com/abhi-bit/go2c) - Communicate between Go and C/C++ using TCP(instead of CGo) <br/> ( 2016-12-06 / 18 commits / 1 stars )
- [akaspin/concurrency](https://github.com/akaspin/concurrency) - --- <br/> ( 2017-05-05 / 12 commits / 0 stars )
- [akaspin/supervisor](https://github.com/akaspin/supervisor) - --- <br/> ( 2017-05-05 / 10 commits / 0 stars )
...
- [asynkronit/protoactor-go](https://github.com/asynkronit/protoactor-go) - Proto Actor - Ultra fast distributed actors for Golang and C# <br/> ( 2017-05-06 / 916 commits / 106 stars )
...
- [couchbase/eventing](https://github.com/couchbase/eventing) - Couchbase Eventing Engine <br/> ( 2017-05-04 / 91 commits / 0 stars )
- [couchbase/goxdcr](https://github.com/couchbase/goxdcr) - --- <br/> ( 2017-05-01 / 640 commits / 5 stars )
...
- [dc0d/supervisor](https://github.com/dc0d/supervisor) - Supervisor trees for Go <br/> ( 2017-04-15 / 10 commits / 2 stars )
- [devsisters/cine](https://github.com/devsisters/cine) - Actor model for golang <br/> ( 2016-08-23 / 38 commits / 5 stars )
...
- [immortal/immortal](https://github.com/immortal/immortal) - ⭕  A *nix cross-platform (OS agnostic) supervisor <br/> ( 2017-04-19 / 620 commits / 11 stars )
...
- [lytics/grid](https://github.com/lytics/grid) - Message Passing and Actors for Golang <br/> ( 2017-05-05 / 618 commits / 2 stars )
- [mackerelio/mackerel-agent](https://github.com/mackerelio/mackerel-agent) - mackerel-agent is an agent program to post your hosts' metrics to mackerel.io. <br/> ( 2017-05-01 / 1,759 commits / 50 stars )
...
- [oklahomer/go-sarah](https://github.com/oklahomer/go-sarah) - Simple yet customizable bot framework written in Go. <br/> ( 2017-05-07 / 260 commits / 0 stars )
- [paulosuzart/gb](https://github.com/paulosuzart/gb) - Go Benchmark. Inspired by Apache Benchmark <br/> ( 2014-07-09 / 94 commits / 8 stars )
- [picadoh/gostreamer](https://github.com/picadoh/gostreamer) - Go example that uses channels to build an execution pipeline <br/> ( 2016-10-05 / 29 commits / 5 stars )
...
- [slyrz/spawn](https://github.com/slyrz/spawn) - Process-based parallelism for Go <br/> ( 2014-01-18 / 3 commits / 3 stars )
...
- [tideland/gocells](https://github.com/tideland/gocells) - Tideland Go Cells <br/> ( 2017-04-15 / 84 commits / 3 stars )
...
- [weaveworks/mesh](https://github.com/weaveworks/mesh) - A tool for building distributed applications. <br/> ( 2017-04-26 / 151 commits / 15 stars )
<!-- /PROJECTS_LIST -->

### By Activity
<!-- ACTIVITY_LIST -->
- [oklahomer/go-sarah](https://github.com/oklahomer/go-sarah): 2017-05-07 <br/> Simple yet customizable bot framework written in Go.
- [asynkronit/protoactor-go](https://github.com/asynkronit/protoactor-go): 2017-05-06 <br/> Proto Actor - Ultra fast distributed actors for Golang and C#
- [akaspin/supervisor](https://github.com/akaspin/supervisor): 2017-05-05 <br/> ---
- [akaspin/concurrency](https://github.com/akaspin/concurrency): 2017-05-05 <br/> ---
- [lytics/grid](https://github.com/lytics/grid): 2017-05-05 <br/> Message Passing and Actors for Golang
- [couchbase/eventing](https://github.com/couchbase/eventing): 2017-05-04 <br/> Couchbase Eventing Engine
- [couchbase/goxdcr](https://github.com/couchbase/goxdcr): 2017-05-01 <br/> ---
- [mackerelio/mackerel-agent](https://github.com/mackerelio/mackerel-agent): 2017-05-01 <br/> mackerel-agent is an agent program to post your hosts' metrics to mackerel.io.
- [weaveworks/mesh](https://github.com/weaveworks/mesh): 2017-04-26 <br/> A tool for building distributed applications.
- [immortal/immortal](https://github.com/immortal/immortal): 2017-04-19 <br/> ⭕  A *nix cross-platform (OS agnostic) supervisor
- [dc0d/supervisor](https://github.com/dc0d/supervisor): 2017-04-15 <br/> Supervisor trees for Go
- [tideland/gocells](https://github.com/tideland/gocells): 2017-04-15 <br/> Tideland Go Cells
...
- [conas/async](https://github.com/conas/async): 2016-11-04 <br/> Go routine isolation and asynchronous utilities.
- [jsouthworth/seriatim](https://github.com/jsouthworth/seriatim): 2016-10-28 <br/> An implementation of Actor semantics on top of go channels with a D-Bus interface
...
- [ledao/goctor](https://github.com/ledao/goctor): 2016-08-12 <br/> A simple actor wraper in go lang
- [raff/starter](https://github.com/raff/starter): 2016-08-04 <br/> a starter / supervisor application
...
- [chrislse/supervisors](https://github.com/chrislse/supervisors): 2016-03-13 <br/> A go implementation of supervisors pattern for goroutines
...
- [bino7/actor](https://github.com/bino7/actor): 2015-06-24 <br/> a distributed system
- [bobappleyard/bwl](https://github.com/bobappleyard/bwl): 2015-05-19 <br/> Bob's Wonderful Go libraries
...
- [nicholaskh/actor](https://github.com/nicholaskh/actor): 2015-03-09 <br/> ---
- [jasongiedymin/voom-builder](https://github.com/jasongiedymin/voom-builder): 2015-01-25 <br/> voom-builder
...
- [paulosuzart/gb](https://github.com/paulosuzart/gb): 2014-07-09 <br/> Go Benchmark. Inspired by Apache Benchmark
...
### By size
<!-- SIZE_LIST -->
- [nicholaskh/actor](https://github.com/nicholaskh/actor): 26.75 MB<br/>  (6.20 MB git / 20.55 MB code)
- [i0n/goose](https://github.com/i0n/goose): 24.77 MB<br/>  (10.91 MB git / 13.86 MB code)
...
- [couchbase/goxdcr](https://github.com/couchbase/goxdcr): 3.48 MB<br/>  (2.07 MB git / 1.41 MB code)
- [fuzzycow/ev32go](https://github.com/fuzzycow/ev32go): 3.43 MB<br/>  (3.18 MB git / 0.25 MB code)
- [mackerelio/mackerel-agent](https://github.com/mackerelio/mackerel-agent): 2.34 MB<br/>  (1.82 MB git / 0.52 MB code)
...
- [immortal/immortal](https://github.com/immortal/immortal): 1.67 MB<br/>  (1.55 MB git / 0.12 MB code)
- [couchbase/eventing](https://github.com/couchbase/eventing): 1.62 MB<br/>  (0.64 MB git / 0.98 MB code)
- [oklahomer/go-sarah](https://github.com/oklahomer/go-sarah): 1.11 MB<br/>  (0.61 MB git / 0.50 MB code)
- [lytics/grid](https://github.com/lytics/grid): 0.98 MB<br/>  (0.71 MB git / 0.27 MB code)
- [weaveworks/mesh](https://github.com/weaveworks/mesh): 0.54 MB<br/>  (0.30 MB git / 0.24 MB code)
- [arschles/gotp](https://github.com/arschles/gotp): 0.48 MB<br/>  (0.46 MB git / 0.01 MB code)
- [tideland/gocells](https://github.com/tideland/gocells): 0.36 MB<br/>  (0.19 MB git / 0.16 MB code)
...
- [bino7/actor](https://github.com/bino7/actor): 0.10 MB<br/>  (0.06 MB git / 0.04 MB code)
- [everpeace/go-actor](https://github.com/everpeace/go-actor): 0.09 MB<br/>  (0.07 MB git / 0.03 MB code)
...
- [kontera-technologies/go-supervisor](https://github.com/kontera-technologies/go-supervisor): 0.06 MB<br/>  (0.04 MB git / 0.02 MB code)
...
- [akaspin/concurrency](https://github.com/akaspin/concurrency): 0.04 MB<br/>  (0.04 MB git / 0.01 MB code)
...
- [slyrz/spawn](https://github.com/slyrz/spawn): 0.04 MB<br/>  (0.02 MB git / 0.01 MB code)
- [pronovix/daemongroup](https://github.com/pronovix/daemongroup): 0.04 MB<br/>  (0.02 MB git / 0.01 MB code)
